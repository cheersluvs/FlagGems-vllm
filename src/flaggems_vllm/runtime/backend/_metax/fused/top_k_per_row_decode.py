...
Swept on the C550 (tools/metax_tle_geometry_sweep.py, kernel mode, drift
...
The row split that used to live here (for the non-TLE path) has been removed;
see git history for it and its measurements."""
