...
STAGE=${1:-}
case "$STAGE" in
    launch|combo|bitonic|private_hist|gaps|focus|collisions|pivot) ;;
    *) echo "Usage: $0 {launch|combo|bitonic|private_hist|gaps|focus|collisions|pivot} [report-name]"; exit 2 ;;
esac
