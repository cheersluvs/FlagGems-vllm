...
#        tools/hygon_prefill_next_run.sh scan_paths_fullrow [report-name]
set -uo pipefail
...
elif [ "$STAGE" = scan_paths_fullrow ]; then
    PROBE=(tools/hygon_prefill_scan_paths.py --stage fullrow)
